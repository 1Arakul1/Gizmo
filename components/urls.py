...
urlpatterns = [
    ...
    # ALL Reviews after
    path('cpus/<int:pk>/add_review/<str:component_type>/', views.add_review, name='add_review'),
    path('gpus/<int:pk>/add_review/<str:component_type>/', views.add_review, name='add_review'),
    path('motherboards/<int:pk>/add_review/<str:component_type>/', views.add_review, name='add_review'),
    path('rams/<int:pk>/add_review/<str:component_type>/', views.add_review, name='add_review'),
    path('storages/<int:pk>/add_review/<str:component_type>/', views.add_review, name='add_review'),
    path('psus/<int:pk>/add_review/<str:component_type>/', views.add_review, name='add_review'),
    path('cases/<int:pk>/add_review/<str:component_type>/', views.add_review, name='add_review'),
    path('coolers/<int:pk>/add_review/<str:component_type>/', views.add_review, name='add_review'),
